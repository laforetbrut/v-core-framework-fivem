...
Config.Recipes = {
    ...
    -- Parts are items: a mechanic can craft their own stock instead of only buying it.
    -- Seed data only — every one of these is editable in-game (Editor → Craft).
    { output = 'part_sparkplugs',        count = 1, time = 4000, station = 'workbench',      inputs = { steel = 1, copper = 1, ceramic = 1 } },
    { output = 'part_airfilter',         count = 1, time = 3000, station = 'workbench',      inputs = { cloth = 2, plastic = 1 } },
    { output = 'part_oilfilter',         count = 1, time = 3500, station = 'workbench',      inputs = { steel = 1, cloth = 1, motor_oil = 1 } },
    { output = 'part_brakes',            count = 1, time = 7000, station = 'workbench',      inputs = { steel = 3, ceramic = 2, screws = 4 } },
    { output = 'part_clutch',            count = 1, time = 8000, station = 'workbench',      inputs = { steel = 3, spring = 2, screws = 4 } },
    { output = 'part_exhaust',           count = 1, time = 9000, station = 'workbench',      inputs = { steel = 4, aluminum_sheet = 2 } },
    { output = 'part_radiator',          count = 1, time = 9000, station = 'workbench',      inputs = { aluminum_sheet = 3, copper = 2, resin = 1 } },
    { output = 'part_suspension',        count = 1, time = 11000, station = 'workbench',      inputs = { steel = 4, spring = 4, rubber = 2 } },
    { output = 'part_steering',          count = 1, time = 9500, station = 'workbench',      inputs = { steel = 3, spring = 1, screws = 4 } },
    { output = 'part_axle',              count = 1, time = 12000, station = 'workbench',      inputs = { steel = 5, titanium = 1 } },
    { output = 'part_tyre',              count = 1, time = 8000, station = 'workbench',      inputs = { rubber = 6, steel = 1 } },
    { output = 'part_bodypanel',         count = 1, time = 7000, station = 'workbench',      inputs = { aluminum_sheet = 3, paint = 1 } },
    { output = 'part_glass',             count = 1, time = 5000, station = 'workbench',      inputs = { glass = 4, resin = 1 } },
    { output = 'part_injectors',         count = 1, time = 8000, station = 'electronics',    inputs = { steel = 1, electronics = 2, wire = 2 } },
    { output = 'part_fuelpump',          count = 1, time = 8500, station = 'electronics',    inputs = { electronics = 2, steel = 1, wire = 2 } },
    { output = 'part_battery',           count = 1, time = 7000, station = 'electronics',    inputs = { lithium_battery = 2, copper = 2, plastic = 2 } },
    { output = 'part_alternator',        count = 1, time = 9000, station = 'electronics',    inputs = { copper = 4, magnet = 2, steel = 1 } },
    { output = 'part_turbo',             count = 1, time = 14000, station = 'workbench',      inputs = { steel = 3, titanium = 1, aluminum_sheet = 2 } },
    { output = 'part_transmission',      count = 1, time = 20000, station = 'workbench',      inputs = { steel = 6, titanium = 1, spring = 3, motor_oil = 2 } },
    { output = 'part_engine',            count = 1, time = 30000, station = 'workbench',      inputs = { steel = 8, titanium = 2, part_sparkplugs = 1, motor_oil = 3 } },
    { output = 'part_coolant',           count = 1, time = 3500, station = 'electronics',    inputs = { resin = 1, water = 2 } },
    { output = 'part_chargeport',        count = 1, time = 7000, station = 'electronics',    inputs = { electronics = 2, copper = 2, plastic = 2 } },
    { output = 'part_bms',               count = 1, time = 10000, station = 'electronics',    inputs = { cpu_chip = 1, electronics = 2, wire = 2 } },
    { output = 'part_inverter',          count = 1, time = 13000, station = 'electronics',    inputs = { electronics = 3, copper = 3, aluminum_sheet = 1 } },
    { output = 'part_motor',             count = 1, time = 24000, station = 'electronics',    inputs = { copper = 6, magnet = 4, steel = 3, part_inverter = 1 } },
    { output = 'part_battery_pack',      count = 1, time = 40000, station = 'electronics',    inputs = { lithium_battery = 8, part_bms = 1, aluminum_sheet = 4, carbon_fiber = 2 } },
    { output = 'diagnostic_scanner',     count = 1, time = 9000, station = 'electronics',    inputs = { electronics = 2, cpu_chip = 1, glass = 1, plastic = 2 } },
}
