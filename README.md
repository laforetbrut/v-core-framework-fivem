...
[![Modules](https://img.shields.io/badge/modules-34-e8a33d.svg)](ARCHITECTURE.md)
...
Enhanced next-gen edition. 34 modules, one shared design system, one database, no external
...
GTA V). 34 modules, un seul design system, une seule base de données, aucune dépendance à un framework
